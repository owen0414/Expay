  ...
  <body>
          ...
          <form id="mem_register_form" autocomplete="off" method="post">
            ...
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              ...
              <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>密碼格式錯誤
                </p>
                <p class="font-red">
            ...
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              ...
              <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>確認密碼需與密碼相同
                </p>
              </div>
            </div>
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
            ...
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              ...
              <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>出生年月日不能為空白
                </p>
              </div>
            </div>
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              ...
              <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>手機格式錯誤
                </p>
              </div>
            </div>
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
            ...
            <div class="col-10 col-md-8 mb-2 px-md-1 mx-auto mx-md-0">
              <p class="is_error issue_error">
                <i class="fas fa-exclamation mr-1"></i>發證日期不能為空白
              </p>
            </div>
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              <div
              ...
              <div class="col-10 col-md-8 mb-0 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>發證地點不能為空白
                </p>
              </div>
            </div>
            <div class="row justify-content-start mt-3 mx-auto mx-md-5">
              ...
              <div class="col-10 col-md-8 mb-2 px-md-0 mx-auto mx-md-2">
                ...
                <p class="is_error">
                  <i class="fas fa-exclamation mr-1"></i>領補換類別不能為空白
                </p>
              </div>
            </div>
    ...
    <script>
      ...
      $("#mem_register_form").submit(function () {
        ...
        if (
          issue_year.val().length < 1 ||
          issue_month.val().length < 1 ||
          issue_day.val().length < 1
        ) {
          $(".issue_error").show();
          result = result && false;
        } else {
        ...
        if (result) {
          ...
          dataJSON["issue_date"] =
            issue_year.val() + issue_month.val() + issue_day.val();
