...
<nav class="navbar bg-light navbar-expand-lg navbar-light smart-scroll py-3 ">
	<a class="navbar-brand" href="<c:url value="/"/>">EX Pay</a>
	<button class="navbar-toggler" type="button" data-toggle="collapse"
		data-target="#navbarNav" aria-controls="navbarNav"
		abtria-expanded="false" aria-label="Toggle navigation">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" data-toggle="modal" data-target="#paymentNotificationModal" style="cursor: pointer;">待付款通知</a></li>
