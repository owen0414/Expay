                    ...
                    <form id="shop_register_form" autocomplete="off" method="post">
                        ...
                        <div class="row justify-content-start mt-3 mx-auto mx-md-5">
                            ...
                            <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-0">
                                <input type="text" class="form-control" id="id" name="id" placeholder="請輸入帳號" />
                        ...
                        <div class="row justify-content-start mt-3 mx-auto mx-md-5">
                            <div class="col-12 col-md-3 px-md-2 text-center text-md-right font-weight-bold">
                                <label for="phone"><span class="font-red">*</span>商家手機：</label>
                            </div>
                            <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-0">
                                <input
                                    type="text"
                                    ...
                                    placeholder="請輸入手機"
                                />
                                <p class="is_error"><i class="fas fa-exclamation mr-1"></i>商家手機不能為空白</p>
                                <p class="is_error"><i class="fas fa-exclamation mr-1"></i>商家手機格式錯誤</p>
                            </div>
                        </div>
                        <div class="row justify-content-start mt-3 mx-auto mx-md-5">
                            <div class="col-12 col-md-3 px-md-2 text-center text-md-right font-weight-bold">
                                ...
                                <div id="twzipcode">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            />
                                            <p class="is_error">
                                                <i class="fas fa-exclamation mr-1"></i>商家地址不能為空白
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-start mt-3 mx-auto mx-md-5">
                            <div class="col-12 col-md-3 px-md-2 text-center text-md-right font-weight-bold">
                                <label for="withdraw_name"><span class="font-red">*</span>負責人姓名：</label>
                            </div>
                            <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-0">
                                <input
                                    type="text"
                                ...
                                />
                                <p class="is_error"><i class="fas fa-exclamation mr-1"></i>負責人姓名不能為空白</p>
                            </div>
                        </div>
                        <div class="row justify-content-start mt-3 mx-auto mx-md-5">
                            <div class="col-12 col-md-3 px-md-2 text-center text-md-right font-weight-bold">
                                <label for="identity"><span class="font-red">*</span>身分證字號：</label>
                            </div>
                            <div class="col-10 col-md-8 px-md-0 mx-auto mx-md-0">
                                <input
                                    type="text"
